      ...
      module = {
        initialize: function () {
          ...
          if (settings.automatic) {
            $prompt.on(inputEvent + eventNamespace, module.throttle);
          }
          $prompt
          ...
          if (cachedHTML) {
            ...
            if (
              ...
              if (settings.apiSettings) {
                module.debug(
                  "Searching with specified API settings",
        ...
        search: {
          local: function (searchTerm) {
            var searchResults = module.search.object(
                searchTerm,
                settings.content
              ),
              searchHTML;
