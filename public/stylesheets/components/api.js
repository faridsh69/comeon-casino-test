...
(function ($, window, document, undefined) {
              ...
              if (settings.dataType == "json") {
                if ($.isFunction(settings.successTest)) {
                  ...
                  if (settings.successTest(response)) {
                    ...
                    module.debug(
                      "JSON test specified by user and response failed",
                      response
                    );
            ...
            error: function (xhr, status, httpMessage) {
              ...
              if (xhr !== undefined) {
                ...
                if (xhr.readyState !== undefined && xhr.readyState == 4) {
                  ...
                  module.debug(
                    "Request Aborted (Most likely caused by page change or CORS Policy)",
                    status,
                    httpMessage
                  );
                }
  ...
  $.api.settings = {
    ...
    error: {
      ...
      missingSerialize:
        "Required dependency jquery-serialize-object missing, using basic serialize",
