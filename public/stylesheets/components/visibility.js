      ...
      module = {
        ...
        should: {
          trackChanges: function () {
            ...
            module.debug(
              "Query is attaching callbacks, watching for changes with scroll"
            );
            return true;
          },
        },
        ...
        set: {
          image: function (src) {
            var offScreen =
              module.cache.screen.bottom < module.cache.element.top;
            $module.attr("src", src);
            if (offScreen) {
        ...
        save: {
          ...
          elementCalculations: function () {
            ...
            $.extend(module.cache.element, {
              visible:
                module.cache.element.topVisible ||
                module.cache.element.bottomVisible,
              passing:
                module.cache.element.topPassed &&
                !module.cache.element.bottomPassed,
              hidden:
                !module.cache.element.topVisible &&
                !module.cache.element.bottomVisible,
            });
            if (module.cache.element.passing) {
              ...
              module.cache.element.percentagePassed =
