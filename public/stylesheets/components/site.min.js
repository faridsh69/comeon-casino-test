        ...
        (s = {
          ...
          performance: {
            log: function (e) {
              ...
              d.performance &&
                ...
                (s.performance.timer = setTimeout(s.performance.display, 100));
            },
            display: function () {
              var n = d.name + ":",
                o = 0;
          ...
          invoke: function (n, o, t) {
            ...
            return (
                ...
                e.each(n, function (o, t) {
                  var r =
                    o != a
                      ...
                      : n;
                  if (e.isPlainObject(l[r]) && o != a) l = l[r];
                  else {
              ...
              e.isFunction(c) ? (u = c.apply(t, o)) : c !== i && (u = c),
              e.isArray(r)
                ? r.push(u)
                : r !== i
                ? (r = [r, u])
